...
import { PatchEdgeConfigItemsRequest$outboundSchema, PatchEdgeConfigItemsResponseBody$inboundSchema, } from "../models/patchedgeconfigitemsop.js";
 ...
 */
export function edgeConfigPatchEdgeConfigItems(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => PatchEdgeConfigItemsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
