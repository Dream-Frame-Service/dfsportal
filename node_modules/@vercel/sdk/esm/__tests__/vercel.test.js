...
test("Vercel Get /Projects/{project Id}/logs Presets", async () => {
    const testHttpClient = createTestHTTPClient("get_/projects/{projectId}/logs-presets");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
    });
...
test("Vercel Post /Projects/{project Id}/logs Presets", async () => {
    const testHttpClient = createTestHTTPClient("post_/projects/{projectId}/logs-presets");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
    });
...
test("Vercel Delete /Projects/{project Id}/logs Presets/{id}", async () => {
    const testHttpClient = createTestHTTPClient("delete_/projects/{projectId}/logs-presets/{id}");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
    });
...
test("Vercel Patch /Projects/{project Id}/logs Presets/{id}", async () => {
    const testHttpClient = createTestHTTPClient("patch_/projects/{projectId}/logs-presets/{id}");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
    });
