    ...
    if (this.state.hasError && this.state.error) {
      ...
      if (this.props.fallback) {
        ...
        return (
          <FallbackComponent
            ...
            pageName={this.props.pageName} data-id="dj0p7plob" data-path="src/components/ErrorBoundary/PageErrorBoundary.tsx" />);
      ...
      return (
        <ErrorFallback
          ...
          undefined
          } data-id="co99zhlb5" data-path="src/components/ErrorBoundary/PageErrorBoundary.tsx" />);
