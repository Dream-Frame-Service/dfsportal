...
const SafeRenderer: React.FC<SafeRendererProps> = ({
  ...
  return (
    <div {...safeProps} data-id="hgxqyf75b" data-path="src/components/SafeRenderer.tsx">
      {children}
    </div>);
...
: React.FC<P> => {
  return (props: P) => {
    try {
      return <Component {...props} data-id="hnp1aizon" data-path="src/components/SafeRenderer.tsx" />;
    } catch (error) {
      if (error instanceof Error && error.name === 'InvalidCharacterError') {
        ...
        return <Component {...sanitizedProps} data-id="he95mg4nw" data-path="src/components/SafeRenderer.tsx" />;
      }
...
export const SafeText: React.FC<{
  ...
  return (
    <Tag
      ...
      {...safeProps}
      dangerouslySetInnerHTML={{ __html: safeText }} data-id="qajoqpm3z" data-path="src/components/SafeRenderer.tsx" />);
...
export const SafeInput: React.FC<React.InputHTMLAttributes<HTMLInputElement> & {
  ...
  return <input {...safeProps} data-id="gw42fval3" data-path="src/components/SafeRenderer.tsx" />;
};
