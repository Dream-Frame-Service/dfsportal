...
/** @internal */
export const GetTeamsTeams$inboundSchema = z.union([TeamLimited$inboundSchema, Team$inboundSchema]);
/** @internal */
export const GetTeamsTeams$outboundSchema = z.union([TeamLimited$outboundSchema, Team$outboundSchema]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var GetTeamsTeams$;
(function (GetTeamsTeams$) {
    /** @deprecated use `GetTeamsTeams$inboundSchema` instead. */
    GetTeamsTeams$.inboundSchema = GetTeamsTeams$inboundSchema;
    /** @deprecated use `GetTeamsTeams$outboundSchema` instead. */
    GetTeamsTeams$.outboundSchema = GetTeamsTeams$outboundSchema;
})(GetTeamsTeams$ || (GetTeamsTeams$ = {}));
