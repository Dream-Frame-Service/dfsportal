...
export class Vercel extends ClientSDK {
    ...
    async postDomains(request, options) {
        return unwrapAsync(postDomains(this, request, options));
    }
    async getProjectsProjectIdLogsPresets(request, options) {
        return unwrapAsync(getProjectsProjectIdLogsPresets(this, request, options));
    }
    async postProjectsProjectIdLogsPresets(request, options) {
        return unwrapAsync(postProjectsProjectIdLogsPresets(this, request, options));
    }
    async deleteProjectsProjectIdLogsPresetsId(request, options) {
        return unwrapAsync(deleteProjectsProjectIdLogsPresetsId(this, request, options));
    }
    async patchProjectsProjectIdLogsPresetsId(request, options) {
        return unwrapAsync(patchProjectsProjectIdLogsPresetsId(this, request, options));
    }
}
